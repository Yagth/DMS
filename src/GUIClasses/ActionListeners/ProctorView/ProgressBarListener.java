...
public abstract class ProgressBarListener extends TableViewPage implements ActionListener {
    ...
    protected void allocateStudents(){
    ...
    protected void loadNewStudents(){
        JavaConnection javaConnection = new JavaConnection(JavaConnection.URL);
